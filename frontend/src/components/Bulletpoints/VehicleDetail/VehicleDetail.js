        ...
        <div className="bulletpoint-detail-frame">
            ...
            <div className="detail-frame" >
                ...
                <div className="detail-frame-properties col-md-6">
                    ...
                    <Property name="Year" id="year" value={vehicle.year ?? ""} disabled={lock} onChange={onChangeYear} ratio={propertyRatio} />
                ...
                <div className="detail-frame-edit">
                    ...
                    {!lock && <button type="button" className="btn btn-light detail-frame-picture-button" onClick={removeVehicle}>Delete vehicle</button>}
                </div>
